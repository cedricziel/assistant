...
class CatalogApi {
  ...
  Future<Response<SubscriptionResponse>> createSubscription({
    ...
    required CreateSubscriptionRequest createSubscriptionRequest,
    ...
    final _path = r'/api/orgs/{org_id}/spaces/{space_id}/subscriptions'
        .replaceAll(
            '{' r'org_id' '}',
    ...
    try {
      const _type = FullType(CreateSubscriptionRequest);
      _bodyData = _serializers.serialize(createSubscriptionRequest,
          specifiedType: _type);
  ...
  Future<Response<void>> deleteCatalogItem({
    ...
    final _path = r'/api/orgs/{org_id}/catalog/{item_id}'
        .replaceAll(
            '{' r'org_id' '}',
            encodeQueryParameter(_serializers, orgId, const FullType(String))
                .toString())
  ...
  Future<Response<void>> deleteSubscription({
    ...
    final _path = r'/api/orgs/{org_id}/spaces/{space_id}/subscriptions/{sub_id}'
        .replaceAll(
            '{' r'org_id' '}',
            encodeQueryParameter(_serializers, orgId, const FullType(String))
                .toString())
        ...
        .replaceAll(
            '{' r'sub_id' '}',
            encodeQueryParameter(_serializers, subId, const FullType(String))
                .toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<CatalogItemResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<CatalogItemResponse>>> listCatalog({
    ...
    final _path = r'/api/orgs/{org_id}/catalog'.replaceAll(
        '{' r'org_id' '}',
        encodeQueryParameter(_serializers, orgId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    BuiltList<CatalogItemResponse>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
            ...
            ) as BuiltList<CatalogItemResponse>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<CatalogItemResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [orgId] - Organization ID
  /// * [type] - Resource type: skill, template, interface
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<CatalogItemResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<CatalogItemResponse>>> listCatalogByType({
    required String orgId,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<SubscriptionResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SubscriptionResponse>>> listSubscriptions({
    required String orgId,
    required String spaceId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    BuiltList<SubscriptionResponse>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
            ...
            ) as BuiltList<SubscriptionResponse>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<SubscriptionResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CatalogItemResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CatalogItemResponse>> publishCatalogItem({
    ...
    try {
      const _type = FullType(PublishCatalogItemRequest);
      _bodyData = _serializers.serialize(publishCatalogItemRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    CatalogItemResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CatalogItemResponse),
    ...
    return Response<CatalogItemResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
