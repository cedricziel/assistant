...
class PushNotificationsApi {
  ...
  Future<Response<TaskPushNotificationConfig>> createPushNotificationConfig({ 
    ...
    TaskPushNotificationConfig? _responseData;
    ...
    return Response<TaskPushNotificationConfig>(
      data: _responseData,
  ...
  Future<Response<ListTaskPushNotificationConfigsResponse>> listPushNotificationConfigs({ 
    ...
    ListTaskPushNotificationConfigsResponse? _responseData;
    ...
    return Response<ListTaskPushNotificationConfigsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
