...
class WebPushApi {
  ...
  const WebPushApi(this._dio, this._serializers);
  ...
  Future<Response<void>> subscribe({
    ...
    final _path = r'/api/push/subscribe';
  ...
  Future<Response<VapidKeyResponse>> vapidPublicKey({
    ...
    final _path = r'/api/push/vapid-public-key';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    VapidKeyResponse? _responseData;
    ...
    return Response<VapidKeyResponse>(
      data: _responseData,
