...
class ApiKeysApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CreateApiKeyResponse] as data
  ...
  Future<Response<CreateApiKeyResponse>> createApiKey({
    ...
    final _path = r'/api/users/me/api-keys';
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(createApiKeyRequest, specifiedType: _type);
    ...
    CreateApiKeyResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CreateApiKeyResponse),
    ...
    return Response<CreateApiKeyResponse>(
      data: _responseData,
  ...
  Future<Response<void>> deleteApiKey({
    ...
    final _path = r'/api/users/me/api-keys/{id}'.replaceAll(
        '{' r'id' '}',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ApiKeySummary>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ApiKeySummary>>> listApiKeys({
    ...
    BuiltList<ApiKeySummary>? _responseData;
    ...
    return Response<BuiltList<ApiKeySummary>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
