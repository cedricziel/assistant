...
class WorkflowsApi {
  ...
  Future<Response<WorkflowRunDetail>> getWorkflowRun({
    ...
    WorkflowRunDetail? _responseData;
    ...
    return Response<WorkflowRunDetail>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<WorkflowWebhookSecrets>> getWorkflowWebhookSecrets({
    ...
    WorkflowWebhookSecrets? _responseData;
    ...
    return Response<WorkflowWebhookSecrets>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<WorkflowRunSummary>>> listWorkflowRuns({
    ...
    BuiltList<WorkflowRunSummary>? _responseData;
    ...
    return Response<BuiltList<WorkflowRunSummary>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<WorkflowSummary>>> listWorkflows({
    ...
    BuiltList<WorkflowSummary>? _responseData;
  ...
  Future<Response<WorkflowRunPreview>> testRunWorkflow({
    ...
    WorkflowRunPreview? _responseData;
    ...
    return Response<WorkflowRunPreview>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
