...
class UsersApi {
  ...
  Future<Response<UserDetail>> createUser({
    ...
    final _path = r'/api/orgs/{org_id}/users'.replaceAll(
        '{' r'org_id' '}',
  ...
  Future<Response<void>> deleteUser({
    ...
    final _path = r'/api/orgs/{org_id}/users/{id}'
        .replaceAll(
            '{' r'org_id' '}',
            encodeQueryParameter(_serializers, orgId, const FullType(String))
                .toString())
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<UserSummary>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<UserSummary>>> listUsers({
    ...
    BuiltList<UserSummary>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(UserSummary)]),
            ) as BuiltList<UserSummary>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<UserSummary>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
