...
class AttachmentsApi {
  ...
  /// Parameters:
  /// * [id] - Attachment ID
  /// * [w] - Desired width in pixels (preserves aspect ratio).
  /// * [h] - Desired height in pixels (preserves aspect ratio).
  ...
  Future<Response<AttachmentMetaResponse>> uploadAttachment({
    ...
    AttachmentMetaResponse? _responseData;
    ...
    return Response<AttachmentMetaResponse>(
      data: _responseData,
