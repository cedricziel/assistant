...
class AccountApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserDetail>> getCurrentUser({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateCurrentUserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateCurrentUserResponse>> updateCurrentUser({
    required UpdateCurrentUserRequest updateCurrentUserRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateCurrentUserRequest);
      _bodyData = _serializers.serialize(updateCurrentUserRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    UpdateCurrentUserResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UpdateCurrentUserResponse),
    ...
    return Response<UpdateCurrentUserResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
