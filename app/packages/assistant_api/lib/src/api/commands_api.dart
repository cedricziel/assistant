...
class CommandsApi {
  ...
  Future<Response<CommandEventResponse>> executeCommand({
    ...
    CommandEventResponse? _responseData;
    ...
    return Response<CommandEventResponse>(
      data: _responseData,
  ...
  Future<Response<BuiltList<CommandDefResponse>>> listCommands({
    ...
    BuiltList<CommandDefResponse>? _responseData;
    ...
    return Response<BuiltList<CommandDefResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<CommandEventResponse>>> listConversationEvents({
    ...
    BuiltList<CommandEventResponse>? _responseData;
    ...
    return Response<BuiltList<CommandEventResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
