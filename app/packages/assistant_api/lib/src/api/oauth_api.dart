...
class OauthApi {
  ...
  /// * [state] - Client-supplied state (forwarded from the authorize request).
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CompleteResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CompleteResponse>> complete({
    String? code,
    String? state,
    String? error,
    String? errorDescription,
    ...
    CompleteResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CompleteResponse),
            ) as CompleteResponse;
    } catch (error, stackTrace) {
      throw DioException(
