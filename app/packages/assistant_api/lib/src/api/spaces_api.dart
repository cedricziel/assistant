...
class SpacesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [SpaceDetail] as data
  ...
  Future<Response<SpaceDetail>> createSpace({
    ...
    final _path = r'/api/orgs/{org_id}/spaces'.replaceAll(
        '{' r'org_id' '}',
    ...
    try {
      const _type = FullType(CreateSpaceRequest);
      _bodyData =
          _serializers.serialize(createSpaceRequest, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(SpaceDetail),
            ) as SpaceDetail;
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<void>> deleteSpace({
    ...
    final _path = r'/api/orgs/{org_id}/spaces/{id}'
        .replaceAll(
            '{' r'org_id' '}',
            encodeQueryParameter(_serializers, orgId, const FullType(String))
                .toString())
  ...
  /// Returns a [Future] containing a [Response] with a [SpaceDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SpaceDetail>> getSpace({
    required String orgId,
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<SpaceSummary>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SpaceSummary>>> listSpaces({
    ...
    BuiltList<SpaceSummary>? _responseData;
    ...
    return Response<BuiltList<SpaceSummary>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [SpaceDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SpaceDetail>> updateSpace({
    required String orgId,
    required String id,
    required UpdateSpaceRequest updateSpaceRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateSpaceRequest);
      _bodyData =
          _serializers.serialize(updateSpaceRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
