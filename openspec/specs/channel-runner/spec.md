...
The system SHALL maintain an LRU cache (capacity 10,000) mapping the adapter's conversation key string to a stable `Uuid`, creating a new UUID on first encounter.
